...
import { CATEGORY_LABELS, CONDITION_LABELS } from "@/lib/mock-data"
...
export default function DeviceDetailClient({ device }: DeviceDetailClientProps) {
  ...
  const deviceFormatted = {
    ...
    brand: device.brand,
    model: device.model,
    variant: device.variant || undefined,
    category: device.category,
    basePrice: device.base_price,
    imageUrl: device.image_url || undefined,
    specifications: device.specifications || undefined,
  }
  ...
  const priceCalculation = useMemo(() => {
    ...
    return calculatePrice(deviceFormatted, selectedCondition, conditionAnswers)
  }, [selectedCondition, conditionAnswers])
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-24 p-6">
              <div className="aspect-square bg-muted/30 rounded-lg flex items-center justify-center p-6 mb-4">
                <img
                  src={device.image_url || "/placeholder.svg?height=400&width=400"}
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-lg">{device.base_price}€</span>
                </div>
...
function getConditionDescription(condition: DeviceCondition): string {
  const descriptions: Record<DeviceCondition, string> = {
    neu: "Gerät ist originalverpackt und unbenutzt, mit allen Originalzubehör",
