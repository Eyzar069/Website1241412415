...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    setIsSupabaseConfigured(hasSupabaseUrl && hasSupabaseKey)
  }, [])
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!isSupabaseConfigured) {
      setError("Supabase ist nicht konfiguriert. Bitte konfigurieren Sie die Umgebungsvariablen.")
      return
    }
          ...
          <CardContent>
            {!isSupabaseConfigured && (
              <Alert variant="destructive" className="mb-4">
                ...
                <AlertDescription>
                  Supabase ist nicht konfiguriert. Bitte stellen Sie sicher, dass die Umgebungsvariablen
                  NEXT_PUBLIC_SUPABASE_URL und NEXT_PUBLIC_SUPABASE_ANON_KEY in den Projekteinstellungen gesetzt sind.
                </AlertDescription>
              </Alert>
            )}
