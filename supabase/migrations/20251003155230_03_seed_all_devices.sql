/*
  # Seed Complete Device Catalog

  ## Overview
  Inserts all 206 devices into the database with complete specifications.

  ## Device Categories Breakdown

  ### Smartphones (95 devices)
  - Apple iPhones: 8 models
  - Samsung Galaxy: 6 models
  - Google Pixel: 4 models
  - Xiaomi: 4 models
  - Sony Xperia: 3 models
  - OnePlus: 3 models
  - Huawei: 3 models
  - Nothing: 3 models
  - Asus: 3 models
  ...
  ## Notes
  - All prices in EUR
  - Uses UPSERT (ON CONFLICT) to allow re-running without duplicates
  - Image URLs reference public folder assets
*/
